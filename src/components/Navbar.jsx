  ...
  return (
    <div>
        ...
        <div class="flex md:order-2">
            <Link to="/add-user">
                <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add</button>            
            </Link>
        </div>
        <div className="duration-100 dark:bg-slate-800 bg-gray-100 rounded-lg dark:text-gray-500">
            {
                options?.map(opt => (
